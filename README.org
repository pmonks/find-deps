...
*** Changelog
- 2021-08-09 (Peter Monks)
  - add development-time tooling (compilation checks, outdated dependency checking, linters)
  - update all dependencies to latest and fix fallout
  - (partially) fix a reflection warning
